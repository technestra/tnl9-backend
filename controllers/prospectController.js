...
//     const suspectDoc = await Suspect.findById(suspect);
//     if (!suspectDoc) {
...
//         companyContact: companyDoc.companyContact
//       },

//       suspectSnapshot: {
//         suspectName: suspectDoc.userName,
//         suspectEmail: suspectDoc.email,
//         suspectContact: suspectDoc.contact
//       },
...
//     // 1️⃣ Suspect REQUIRED in both modes
...
//     // 3️⃣ Primary contact from suspect
//     const primaryContact =
//       suspectDoc.contacts?.length > 0
//         ? suspectDoc.contacts[0].value
//         : "";
